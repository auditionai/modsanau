...
{
    [Fact]
    public void Account_page_is_accessible_adaptive_and_uses_design_system()
    {
        ...
        Assert.Contains("Header=\"Mã quà tặng\"", text, StringComparison.Ordinal);
        Assert.Contains("AutomationProperties.Name=\"Nhập mã quà tặng\"", text, StringComparison.Ordinal);
