...
| STM-09 | Update with wrong signature rejected | Hai case trong `AppUpdateVerificationTests` | Manifest/package sai chữ ký/publisher/hash bị từ chối trước install. |
